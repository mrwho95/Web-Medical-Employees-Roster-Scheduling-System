      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item active" href="<?php echo base_url(); ?>assets/404.html">404 Page</a>
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="<?php echo base_url(); ?>assets/index.html">Dashboard</a>
            </li>
          ...
          <p class="lead">Page not found. You can
            <a href="<?php echo base_url(); ?>assets/javascript:history.back()">go back</a>
            to the previous page, or
            <a href="<?php echo base_url(); ?>assets/index.html">return home</a>.</p>
