...
class Registration extends CI_Controller
{
	...
	public function form_validation()
	{
		...
		if ($this->form_validation->run())
		{
			...
			if ($this->main_model->check_exist_scheduler($data['SchedulerID'])){
				$this->session->set_flashdata('duplicate_user_msg', 'This Scheduler ID already registered, you cannot add it more.');
	...
	public function admin_form_validation()
	{
		...
		if ($this->form_validation->run())
		{
			...
			$this->load->model("main_model");
			if ($this->main_model->check_exist_admin($data['AdminID'])) {
				$this->session->set_flashdata('duplicate_user_msg', 'This Admin ID already registered, you cannot add it more.');
